      ...
      <Grid container className={classes.container}>
        <Grid item>
          <Typography
            ...
            sx={{ typography: theme => theme.typography.footer }}
          >
        ...
        <Grid item position={'absolute'} justifySelf={'right'}>
          <Button
            ...
            style={{
              color: showTextArea == false ? 'white' : '#833177',
              backgroundColor: showTextArea == false ? '#833177' : '#F5F5F5',
            }}
          >
            <TextSnippetIcon />
            &nbsp;Nota rápida{' '}
            {showTextArea ? (
              <AddIcon style={{ marginLeft: '14rem' }} />
            ) : (
              <RemoveIcon style={{ marginLeft: '14rem' }} />
            )}
          </Button>
          <div
            style={{
