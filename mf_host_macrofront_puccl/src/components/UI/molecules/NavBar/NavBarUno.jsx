...
export default function PermanentDrawerLeft() {
  ...
  return (
    <>
            ...
            <Box sx={{ overflow: "auto"}}>
              <List >
                  <ListItem disablePadding>
                    <ListItemButton onClick={() => HandleClick('Atenciones')} style={{margin:"center", 
      ...
      <div style={{marginTop: '50px', width: '244px',borderRight: '1px solid #D8D8D8', height: '90vh', overflow:'auto'}}>
            {renderModule()}
          </div>
    </>
  );
